...
const CATEGORIES = [
  ...
  { name: 'Spices', emoji: '🌶️', desc: 'Pure ground spice blends', color: '#fff7ed', border: '#fb923c', img: '/products/red_chili.png' },
    ...
    <div className="min-h-screen bg-[#fdfbf7]" style={{ fontFamily: "'Inter', sans-serif" }}>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[10px] font-extrabold text-orange-600 tracking-widest">STORES & SAVORIES</div>
            </div>
          </Link>
          <nav className="hidden md:flex items-center gap-8 text-sm font-semibold text-stone-600">
            ...
            <a href="#features" className="hover:text-orange-600 transition-colors">About</a>
            <a href="#contact" className="hover:text-orange-600 transition-colors">Contact</a>
          </nav>
          <div className="flex items-center gap-3">
            {customerAuth ? (
              <Link to="/shop" className="flex items-center gap-2 text-sm font-bold text-orange-700 bg-orange-50 border border-orange-200 px-4 py-2 rounded-xl hover:bg-orange-100 transition-colors">
                <span className="w-6 h-6 bg-orange-500 rounded-full flex items-center justify-center text-white font-black text-xs">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 bg-orange-100 border border-orange-200 text-orange-700 text-xs font-extrabold px-4 py-2 rounded-full mb-6 tracking-wide">
              🎉 100% Homemade · Traditional Recipes
            </div>
            <h1 className="text-5xl lg:text-6xl font-black text-stone-900 leading-tight mb-6"
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              ...
              <Link to="/customer-login"
                className="px-8 py-4 rounded-2xl font-extrabold text-stone-700 text-base bg-white border-2 border-stone-200 hover:border-orange-300 hover:text-orange-700 transition-all hover:scale-105 shadow-sm">
                Create Account
              </Link>
            </div>
            {/* Trust stats */}
            <div className="flex gap-8 mt-12 justify-center lg:justify-start">
              {[['500+', 'Happy Customers'], ['20+', 'Products'], ['4.8★', 'Avg Rating']].map(([val, lbl]) => (
                <div key={lbl} className="text-center lg:text-left">
                  <div className="text-2xl font-black text-orange-600">{val}</div>
            ...
            <div className="relative w-full max-w-md mx-auto">
              <div className="grid grid-cols-2 gap-4">
                {['/products/mango_pickle.png', '/products/kaju_katli.png', '/products/filter_coffee.png', '/products/samosa.png'].map((src, i) => (
                  <div key={i} className={`rounded-3xl overflow-hidden shadow-2xl border-4 border-white ${i === 0 ? 'col-span-1 row-span-1' : ''}`}
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-2xl px-5 py-3 shadow-xl border border-stone-100 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-orange-500 text-xs font-bold">Fresh daily</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-12">
          <p className="text-orange-600 font-extrabold text-sm tracking-widest uppercase mb-2">Browse by Category</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {CATEGORIES.map((cat) => (
            <Link
              ...
              className="group flex flex-col items-center text-center p-5 rounded-3xl border-2 transition-all hover:scale-105 hover:shadow-xl cursor-pointer"
      ...
      {/* ─── Features ─── */}
      <section id="features" className="bg-stone-900 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <p className="text-orange-400 font-extrabold text-sm tracking-widest uppercase mb-2">Why Choose Us</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {FEATURES.map((f) => (
              <div key={f.title} className="bg-stone-800 rounded-3xl p-7 border border-stone-700 hover:border-orange-500/50 transition-all hover:-translate-y-1">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="flex items-center justify-between mb-10">
          <div>
            <p className="text-orange-600 font-extrabold text-sm tracking-widest uppercase mb-1">Best Sellers</p>
            <h2 className="text-3xl font-black text-stone-900" style={{ fontFamily: "'Outfit', sans-serif" }}>
              Customer Favourites
            </h2>
          </div>
          <Link to="/shop" className="text-orange-600 hover:text-orange-700 font-extrabold text-sm underline underline-offset-4">
            View All →
          </Link>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
          {[
            ...
            <Link key={p.name} to="/shop"
              className="group bg-white rounded-3xl overflow-hidden border border-stone-200 hover:border-orange-300 shadow-sm hover:shadow-xl transition-all hover:-translate-y-1">
      ...
      <section className="bg-orange-50 border-y border-orange-100 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <p className="text-orange-600 font-extrabold text-sm tracking-widest uppercase mb-2">Testimonials</p>
            <h2 className="text-4xl font-black text-stone-900" style={{ fontFamily: "'Outfit', sans-serif" }}>What our customers say</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {TESTIMONIALS.map((t) => (
              <div key={t.name} className="bg-white rounded-3xl p-7 shadow-sm border border-orange-100 hover:shadow-md transition-all">
                <div className="flex gap-1 mb-4">
                  {Array.from({ length: t.stars }).map((_, i) => <span key={i} className="text-amber-400 text-base">★</span>)}
                </div>
                <p className="text-stone-700 text-sm font-medium leading-relaxed mb-6 italic">"{t.text}"</p>
                <div className="flex items-center gap-3 pt-4 border-t border-stone-100">
                  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-orange-400 to-amber-400 flex items-center justify-center text-white font-black text-sm">
                    {t.name.charAt(0)}
                  </div>
                  <div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="rounded-3xl p-12 text-center relative overflow-hidden"
          ...
          <div className="relative z-10">
            ...
            <p className="text-orange-100 text-base font-medium mb-8 max-w-lg mx-auto">
              Shop our full collection of 20+ authentic homemade products. Fresh. Pure. Delivered.
            </p>
            <div className="flex gap-4 justify-center flex-wrap">
              <Link to="/shop"
                className="px-8 py-4 bg-white text-orange-700 font-black rounded-2xl text-base shadow-xl hover:shadow-2xl hover:scale-105 transition-all">
                Shop All Products 🛒
              </Link>
              <Link to="/customer-login"
            ...
            <div className="md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className="text-orange-400 text-[10px] font-bold tracking-widest">STORES & SAVORIES</div>
                </div>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                {[['Home', '/'], ['Shop', '/shop'], ['Sign In', '/customer-login'], ['Admin', '/login']].map(([label, path]) => (
                  <li key={label}><Link to={path} className="text-stone-400 hover:text-orange-400 transition-colors font-medium">{label}</Link></li>
                ))}
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm">
                {CATEGORIES.map((c) => (
                  <li key={c.name}><Link to={`/shop?category=${c.name}`} className="text-stone-400 hover:text-orange-400 transition-colors font-medium">{c.emoji} {c.name}</Link></li>
                ))}
              </ul>
            </div>
          </div>
